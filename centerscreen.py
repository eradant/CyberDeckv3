...
sht40 = adafruit_sht4x.SHT4x(tca[4])
##################################################################################################################################
...
text_z = "DeckV3"
z_text = label.Label(font, text=text_z, color = aqua)
z_text.anchor_point = (0.0, 0.0)
z_text.anchored_position = (15, 4)
group.append(z_text)

text_x = " "
x_text = label.Label(font, text=text_x, color=purple)
x_text.anchor_point = (0.0, 0.0)
x_text.anchored_position = (3, 24)
group.append(x_text)

text_v = " "
v_text = label.Label(font, text=text_v, color=green)
v_text.anchor_point = (0.0, 0.0)
v_text.anchored_position = (3, 14)
group.append(v_text)
...
while True:
    ...
    x_text.text = "H(%):{:.2f}".format(sht40.relative_humidity)
    v_text.text = "T(C):{:.2f}".format(sht40.temperature)
